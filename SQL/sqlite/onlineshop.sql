...
CREATE TABLE OrderDetails (
  OrderDetailID int(11) PRIMARY KEY NOT NULL,
...
CREATE TABLE Products (
  ...
  FOREIGN KEY (SupplierID) REFERENCES Suppliers(SupplieID),
...
CREATE TABLE Shippers(
  ShipperID int(11) PRIMARY KEY NOT NULL,
...
CREATE TABLE Suppliers(
  SupplierID int(11) PRIMARY KEY NOT NULL,
